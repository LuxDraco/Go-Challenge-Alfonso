...
func ListTasks() {
	...
	response, err := http.Get("http://127.0.0.1:8081/tasks")
...
func ListSingleTask() {
	...
	response, err := http.Get("http://localhost:8081/tasks")
...
func CreateTask() {
	...
	response11, err11 := http.Get("http://localhost:8081/tasks")
	...
	values := []string{"http://localhost:8081/tasks", indexString}
